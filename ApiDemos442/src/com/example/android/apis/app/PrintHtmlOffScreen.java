 ...
 * {@link WebView} which is not shown on the screen.
 * <p>
 * This activity shows a text prompt and when the user chooses the print option
 * from the overflow menu an HTML page with content that is not on the screen is
 * printed via an off-screen {@link WebView}.
 * </p>
 * 
 * @see PrintManager
 * @see WebView
 */
public class PrintHtmlOffScreen extends DJLActivity {
