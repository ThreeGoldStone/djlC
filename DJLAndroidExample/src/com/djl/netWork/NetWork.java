...
public class NetWork {
	...
	public static void getXXX(Context context, SimpleVolleyListener<String> listener, String... xxx) {
		// 初始化请求队列
		initQueue(context);
		// TODO xxxxx
	...
	public static void postXXX(Context context, SimpleVolleyListener<String> listener, String... xxx) {
		// 初始化请求队列
		initQueue(context);
		SimpleStringRequst request = new SimpleStringRequst(Method.POST, url, listener, listener);
